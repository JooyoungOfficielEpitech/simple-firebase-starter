...
const es: Translations = {
  ...
  matchingScreen: {
    matchingButton: "Iniciar Coincidencia",
  },
  signInScreen: {
  ...
  auth: {
    ...
    errors: {
      ...
      signInInProgress: "Ya hay una operación de inicio de sesión en progreso",
      playServicesNotAvailable: "Servicios de Google Play no disponibles o desactualizados",
      logoutFailed: "Error al cerrar sesión",
      userNotFound: "Usuario no encontrado",
      emailVerificationFailed: "Error al enviar verificación por correo",
      reloadFailed: "Error al actualizar información del usuario",
      emailUpdateFailed: "Error al actualizar dirección de correo",
    },
  },
  errorScreen: {
