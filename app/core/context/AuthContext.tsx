...
import { useSingleFirebaseListener } from "@/core/hooks/useFirebaseListener"
import { firebaseCleanupManager } from "@/core/utils/firebaseCleanup"
...
export const AuthProvider: FC<PropsWithChildren<AuthProviderProps>> = ({ children }) => {
  ...
  useEffect(() => {
    console.log('🔐 [AuthContext] Auth 상태 리스너 설정 시작')
    ...
    return () => {
      console.log('🔐 [AuthContext] Auth 상태 리스너 정리')
      cleanupAuthListener()
    }
  }, [])
